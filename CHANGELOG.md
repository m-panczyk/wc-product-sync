...
### 0.9.27-rc8 — [krytyczne] kolizja SKU wariacji (#36); + total sync po nazwie (#32), i18n, logi, CI, readme.txt

_Uwaga: rc7 nie trafił do kanału RC (wadliwy tag) — rc8 jest pierwszym realnym wydaniem RC od rc6, więc poniżej pełna delta rc6 → rc8. Gwóźdź: #37._
